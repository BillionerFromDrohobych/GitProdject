...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public void choise(String name, int imgurl, String location, String desctription, boolean sightorcity, String adress) {
        ...
        switch (name) {
            case "Kiev":
                cityData.clear();
                cityData.add(new City("Kiev Politechnik Institute", R.drawable.kpi, "geo:50.454978,30.445443?q=Igor Sikorsky Kyiv Polytechnic Institute", "0", true, "37, Prosp.Peremohy, Solomyanskyi district, Kyiv, Ukraine, 03056"));
                cityData.add(new City("Taras Shevchenko National University of Kyiv", R.drawable.kiev, "", "0", true,"vul. Saint Ostapuchi"));
            break;
            case "Lviv":
                cityData.clear();
                cityData.add(new City("Italian courtyard", R.drawable.italiancourtyard, "geo:49.841562,24.031144?q=Italian courtyard", "0", true,"Rynok Square, 6, L'viv, L'vivs'ka oblast, 79000"));
